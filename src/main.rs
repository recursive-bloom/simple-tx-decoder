...
//// https://etherscan.io/tx/0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52
//// https://etherscan.io/getRawTx?tx=0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52

//// https://etherscan.io/vmtrace?txhash=0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52
//// GETH Trace for Txn Hash 0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52

//// https://etherscan.io/vmtrace?txhash=0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52&type=parity
//// PARITY Trace for Txn Hash 0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52

////https://cn.etherscan.com/tx/0x083cc4af906c0b8b67a630507f695aa0dab2bde84fada412fff608d0ee9ea1ae
////Ecoball test
...
"action": {
  "callType": "call",
  "from": "0x8d1144b4c2b719a2618b9742364c8e1a8f925ae5",
  "gas": "0x584",
  "input": "0xa9059cbb00000000000000000000000085206176182d759c75a8ec4c884ac282f58d7b3d000000000000000000000000000000000000000000000005f68e8131ecf80000",
  "to": "0x00e150d741eda1d49d341189cae4c08a73a49c95",
  "value": "0x0"
},
"blockHash": "0x0a3abf5f9fef90795e3e422676a9ee35605648fe171de3b2143de4ed43d85df4",
"blockNumber": 9413107,
"result": {
  "gasUsed": "0x584",
...
"subtraces": 0,
"traceAddress": [],
"transactionHash": "0xcf761d6b96368b84f1faf4caec03042fb29bfb645e76293c7a96f54d21d8ea52",
...
fn should_agree_with_vitalik() {
    ...
    let test_vector = |tx_data: &str, address: &'static str| {
        ...
        assert_eq!(signed.sender(), Address::from_str(&address[2..]).unwrap()); // Start with 0x...

        //println!("signed.sender: {:?}", signed.deconstruct());
        let (uv_tx, addr, pub_key) = signed.deconstruct();

        println!("Unverified Transaction:\n{:?}", uv_tx);
        println!("Address:\n{:?}", addr);
        println!("Public key:\n{:?}", pub_key);

        //println!("signed.sender: {:?}", signed.sender());
        //println!("addreess:      {}", address);
        //println!("addreess_str: {:?}", address);
        //println!("chainid: {:?}", signed.chain_id());
    };

    let raw_tx = "";
    let sender_addr = "0x8d1144b4c2b719a2618b9742364c8e1a8f925ae5";
    test_vector(raw_tx, sender_addr);

    let raw_tx = "";
    let sender_addr = "0x59a5208b32e627891c389ebafc644145224006e8";
    test_vector(raw_tx, sender_addr);
}
...
mod tests {
    ...
    fn should_agree_with_vitalik() {
        ...
        let test_vector = |tx_data: &str, address: &'static str| {
            let signed = rlp::decode(&FromHex::from_hex(tx_data).unwrap()).expect("decoding tx data failed");
            let signed = SignedTransaction::new(signed).unwrap();
            println!("chainid: {:?}", Address::from_str(&address[2..]).unwrap());
